...
ExceptionNotification.configure do |config|
  ...
  # Erreurs de requête (4xx), en pratique des bots : pas de mail
  ...
  config.add_notifier :email, {
    ...
    exception_recipients: %w{philippe.nougaillon@aikku.eu, pierre-emmanuel.dacquet@aikku.eu, alexandre.meunier@aikku.eu, serena.pinali@aikku.eu}
  }
